...
CONFIG_FILE="${1:?Usage: 01_fastq_qc.sh CONFIG sample_id|raw_multiqc|post_trim_multiqc|multiqc}"
TARGET="${2:?Usage: 01_fastq_qc.sh CONFIG sample_id|raw_multiqc|post_trim_multiqc|multiqc}"
